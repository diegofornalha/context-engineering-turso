...
-- ============================================
-- LIMPEZA E CRIAÇÃO DA NOVA ESTRUTURA
-- ============================================
...
-- Buscar todos os docs PRP
-- SELECT title, cluster, category FROM docs_prp ORDER BY cluster, title;

-- Buscar todos os docs Turso
-- SELECT title, cluster, category FROM docs_turso ORDER BY cluster, title;

-- Buscar docs por cluster
-- SELECT title, content FROM docs_prp WHERE cluster = '02-agent-architecture';

-- Buscar docs por tags
-- SELECT title, content FROM docs_prp WHERE tags LIKE '%delegação%';

-- Buscar docs por categoria
-- SELECT title, content FROM docs_turso WHERE category = 'documentation';
